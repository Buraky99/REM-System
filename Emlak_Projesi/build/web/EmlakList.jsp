...
<center>
        ...
        <h2>
        	<a href="list" style="background-color:buttonhighlight">Mülkleri kontrol et</a>
                <br></br>
              ...
              <article class="aa-properties-item">
                ...
                <div class="aa-properties-item-content">
                  <div class="aa-properties-info">
                    <span><td><c:out value="${emlak.il}" /></td></span>
                    <span><td><c:out value="${emlak.ilce}" /></td></span>  
                    <span><td><c:out value="${emlak.ozellik}" /></td></span>  
                 
                  </div>
                  <div class="aa-properties-about">
                    <h3><a href="#"><span><td><c:out value="${emlak.id}" /></td></span></a></h3>
                                   
                  </div>
                  <div class="aa-properties-detial">
                    <span class="aa-price">
                      <span><td><c:out value="${emlak.fiyat} TL" /></td></span> 
                    </span>
